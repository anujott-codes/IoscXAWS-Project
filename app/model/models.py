...
class Student(Base):
    ...
    #id = Column(Integer, primary_key=True, autoincrement=True)
    roll_number = Column(String, primary_key=True, index=True, nullable=False)
...
class Internship(Base):
    ...
    id = Column(Integer, primary_key=True, autoincrement=True)
    student_id = Column(String, ForeignKey("students.roll_number"), nullable=False)
...
class AcademicDocuments(Base):
    ...
    sem1_marksheet = Column(String, nullable=True)
    sem2_marksheet = Column(String, nullable=True)
    sem3_marksheet = Column(String, nullable=True)
    sem4_marksheet = Column(String, nullable=True)
    sem5_marksheet = Column(String, nullable=True)
    sem6_marksheet = Column(String, nullable=True)
    sem7_marksheet = Column(String, nullable=True)
    sem8_marksheet = Column(String, nullable=True)
